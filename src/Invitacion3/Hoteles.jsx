...
function Hoteles(){
  ...
  return(
    <SectionHotel>
      ...
      <br></br>
      <Span>
        Este es el hotel propio de la finca donde tendrá lugar nuestro día. Para los que venís de fuera, la finca nos guarda unas habitaciones, por si os queréis quedar allí esos días.<br></br><br></br>
        <div div style={{textAlign: 'left', fontSize: '20px', fontFamily: 'Montserrat', fontStyle: 'italic'}}>
